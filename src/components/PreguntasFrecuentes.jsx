  ...
  return (
    <div>
      <PreguntaFrecuente 
        ...
        realizar el paso a paso para realizar una reserva online: `}
        boton={<button className={FooterCSS.soporte} onClick={soporte}>Soporte</button>} 
        />
        
      <PreguntaFrecuente 
      pregunta="Además de la web, ¿Existe otro método para poder comprar?" 
      respuesta="Si. Podes hacerlo con el asesoramiento de uno de nuestros especialistas, haciendo click en el siguiente link: "
      boton={<button className={FooterCSS.soporte} onClick={soporte}>Soporte</button>} 
      />
