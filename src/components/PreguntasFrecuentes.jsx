...
const PreguntasFrecuentes = () => {
  return (
    <div>
      <PreguntaFrecuente pregunta="¿Cómo puedo realizar una reserva online?" respuesta="Accediendo al siguiente link, vas a poder realizar el paso a paso para realizar una reserva online: (link de inicio de reserva)" />
